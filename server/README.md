...
## Models
This section documents the models used for the toolkit. These are basically how the tables are structured in the database. The model classes allow for easier/consistent reading and writing. Think of them as the communication protocol between the database and server.
...
## Schemas
These help enforce strcuture on, and validate recived data. Think of them as the communication protocol between client/target and the server.
